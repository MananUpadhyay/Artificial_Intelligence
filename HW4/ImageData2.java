...
public class ImageData {
	...
	public static void main(String[] args) {
		//String dir = "C:\\Users\\Jimmy\\Desktop\\cs561\\hw4data\\";

		ArrayList<ImageData> imagesTrain = readData("train-images.idx3-ubyte", "train-labels.idx1-ubyte");
		ArrayList<ImageData> imagesTest = readData("test-images.idx3-ubyte", "test-labels.idx1-ubyte");
		imagesTrain.get(10).drawImage();
		imagesTest.get(10).drawImage();
		System.out.println(imagesTrain.get(10).label);
		System.out.println(imagesTest.get(10).label);
